...
%  Step through the recorded sync pulses in chunks of  windsize.  Use corr to find the chunks of 
%behavioral pulse times where the inter-pulse intervals are correlated.  When the maximum 
%correlation is greater than corrThresh, then it indicates that the pairs match.
