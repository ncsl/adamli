function [events] = createStimEvents_v1a(sessLogFile, subject, sessionName, sessionNum,eegDir)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
% figure,
% stem([events(10:end).mstime],[events(10:end).stimulusLevel]), axis tight
% title(sprintf('Session: %d',sessionNum));
if fixCount,
    fprintf('Fix %d annotations in %s DC10 updown and rerun\n', fixCount, sessionName'); end
