...
%
%  JW Summary: this function provides ms resolution mt analysis good for spectrograms, 
%     though it doesn't produce the same results as are found by windowing with pmtm and using FFT.
%     It seems that the multitapers are combined in the time domain and then convolved 
%     with the time series.  The temporal resolution is superior to what you *should* see
%     with the specified windowsize.  Computation time is long compared to pmtm or Julios method.
%     
% 
%
% FUNCTION:
