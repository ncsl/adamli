function [varargout] = getphasepow2(chan,events,DurationMS,OffsetMS,BufferMS,varargin)
...
%
% FUNCTION:
%   [phase,pow,kInd] = getphasepow2(chan,events,DurationMS,OffsetMS,BufferMS,varargin)
%
% INPUT ARGs:
%   chan = 2;
%   events = events;
...
[phase,pow] = multiphasevec3(freqs,eeg,samplerate,width);
