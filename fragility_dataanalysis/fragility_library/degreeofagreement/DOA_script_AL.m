...
%% PLOTTING
FONTSIZE = 20;
numPats = ceil(length(patients)/2);
...
% h = suptitle(strcat(patient_id, ' | Start to Seizure'));
h = suptitle('All Patients');
...
toSaveFigFile = fullfile(figDir, strcat('alliipatients', '_allmetrics_startto0'));
