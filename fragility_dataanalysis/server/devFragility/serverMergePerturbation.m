...
if FILTERTYPE == 1
    ...
    toSavePertDir = fullfile(serverDir, ...
        'harmonics', strcat('perturbations', '_radius', num2str(radius)),...
        strcat('win', num2str(winSize), '_step', num2str(stepSize), '_freq', num2str(frequency_sampling)), ...
        patient);
elseif FILTERTYPE == 2
    %%- adaptive filtering harmonics
    toSavePertDir = fullfile(serverDir, ...
            'perturbationmats/adaptivefilter', strcat('perturbations', '_radius', num2str(radius)),...
            strcat('win', num2str(winSize), '_step', num2str(stepSize), '_freq', num2str(frequency_sampling)), ...
            patient)
else 
    %%- w/o filtering harmonics
    toSavePertDir = fullfile(serverDir, ...
            strcat('perturbations', '_radius', num2str(radius)),...
            strcat('win', num2str(winSize), '_step', num2str(stepSize), '_freq', num2str(frequency_sampling)), ...
            patient);
end
