...
%     typeTransform = 'morlet';
    ...
    if FILTER_RAW == 1
         tempDir = fullfile(rootDir, 'server/devVaryingWindows/preProcess/tempData/',...
            strcat(typeTransform, '/notchharmonics_win', num2str(winSize), ...
                '_step', num2str(stepSize), '_freq', num2str(fs)), patient);
    elseif FILTER_RAW == 2
         tempDir = fullfile(rootDir, 'server/devVaryingWindows/preProcess/tempData/',...
            strcat(typeTransform, '/adaptivefilter_win', num2str(winSize), ...
                '_step', num2str(stepSize), '_freq', num2str(fs)), patient);
    else 
         tempDir = fullfile(rootDir, 'server/devVaryingWindows/preProcess/tempData/',...
            strcat(typeTransform, '/nofilter_win', num2str(winSize), ...
                '_step', num2str(stepSize), '_freq', num2str(fs)), patient);
    end
