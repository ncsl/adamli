...
elseif strcmp(patient_id, 'UMMC002')
    ...
    onset_electrodes = {'ANT1', 'ANT2', 'ANT3',...
...
elseif strcmp(patient_id, 'UMMC007')
    ...
    onset_electrodes = {'LM1', 'LMT2', 'LMT3', 'LMT4',...
        'RMT1', 'RAT1', 'RAT2', 'RAT3', 'RAT4', ...
        'RPT3', 'RPT4', 'RPT5', ...
        'LPT3', 'LAT4', 'LAT5'};
    onset_electrodes = {'LMES1', 'LMES2', 'LMES3', 'LMES4',...
...
elseif strcmp(patient_id, 'UMMC008')
    included_channels = [1:30];
    onset_electrodes = {'GRID1', 'GRID2', 'GRID3', 'GRID4', 'GRID5', 'GRID9',...
